...
const displayNewsCategory = catagorys => {
    ...
    catagorys.forEach(catagory => {
        ...
        creatDiv.innerHTML = `
        <a onclick="loadNewsDetails('${catagory.category_id}')" href="#news-category" class="container text-decoration-none text-black fs-5 fw-bold">${catagory.category_name}</a>
        <hr>
        `;
